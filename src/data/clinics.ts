...
export const clinicsData: ClinicData[] = [
  {
    ...
    slug: "eunoia-clinic",
    name: "Eunoia Clinic",
    cardImage: logo("/clinics/eunoia-clinic/logo.png", "Eunoia Clinic"),
    logo: logo("/clinics/eunoia-clinic/logo.png", "Eunoia Clinic"),
    gallery: [
      banner(
        "/clinics/eunoia-clinic/banner-all-pages-new-scaled.jpg",
        "Eunoia Clinic front desk banner",
      ),
      banner(
        "/clinics/eunoia-clinic/Clinical-Traning.jpg",
  ...
  },
  {
    ...
    cardImage: logo("/clinics/hayat-counseling-center/logo.jpg", "Hayat Counseling Center"),
    logo: logo("/clinics/hayat-counseling-center/logo.jpg", "Hayat Counseling Center"),
    gallery: [],
  ...
  },
  {
    ...
    cardImage: logo("/clinics/al-harub-medical-center/logo.png", "Al Harub Medical Center"),
    logo: logo("/clinics/al-harub-medical-center/logo.png", "Al Harub Medical Center"),
    gallery: [],
  ...
  },
  {
    ...
    cardImage: logo(
      "/clinics/whispers-of-serenity-clinic/logo.jpg",
    ...
    gallery: [
      banner(
        "/clinics/whispers-of-serenity-clinic/img2.jpg",
        "Whispers of Serenity Clinic reception area",
      ),
      banner(
        "/clinics/whispers-of-serenity-clinic/img1.jpg",
  ...
  },
  {
    ...
    cardImage: logo("/clinics/ehtewa-mental-health-clinic/logo.jpg", "Ehtewa Mental Health Clinic"),
    logo: logo("/clinics/ehtewa-mental-health-clinic/logo.jpg", "Ehtewa Mental Health Clinic"),
    gallery: [
      banner(
        "/clinics/ehtewa-mental-health-clinic/img1.jpg",
        "Ehtewa Mental Health Clinic poster",
        "contain",
        "soft",
      ),
      banner(
        "/clinics/ehtewa-mental-health-clinic/img2.jpg",
        "Ehtewa Mental Health Clinic poster",
        "contain",
        "soft",
      ),
